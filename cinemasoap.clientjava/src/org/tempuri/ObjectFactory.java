...
public class ObjectFactory {
    ...
    private final static QName _GetReservationListEmail_QNAME = new QName("http://tempuri.org/", "email");
    ...
    public JAXBElement<String> createGetReservationListEmail(String value) {
        return new JAXBElement<String>(_GetReservationListEmail_QNAME, String.class, GetReservationList.class, value);
    }
    ...
    public JAXBElement<String> createBookScreeningEmail(String value) {
        return new JAXBElement<String>(_GetReservationListEmail_QNAME, String.class, BookScreening.class, value);
    }
