    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:7979/CinemaService.svc?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:7979/CinemaService.svc?wsdl', retrying as a local file");
