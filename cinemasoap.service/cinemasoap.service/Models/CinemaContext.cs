...
namespace cinemasoap.service.Models
{
    public class CinemaContext 
    {
        ...
        private void InitScreenings()
        {
            ...
            Screenings.Add(new Screening (new Guid("8a4b86e4-acc9-476f-bae4-a58038791ed6"), new DateTime(today.Year, today.Month, today.Day, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("dae8591e-ecd7-4a3b-b9d2-76c17cc2042a"), new DateTime(today.Year, today.Month, today.Day, 15, 45, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("bd54a687-65b7-460a-acef-1431960f1e78"), new DateTime(today.Year, today.Month, today.Day, 20, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));

            Screenings.Add(new Screening (new Guid("aca6edd2-85d3-4673-af10-4007fb749e9f"), new DateTime(today.Year, today.Month, today.Day+1, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("c486acd6-c62f-495e-b726-bd3acc8ccbaa"), new DateTime(today.Year, today.Month, today.Day+1, 21, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("6bb909d4-57a4-48a3-b067-65edbe64ad3d")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("0cc4d40c-71d9-4f5a-a75a-b8230735689f"), new DateTime(today.Year, today.Month, today.Day+1, 14, 40, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("db57ec8e-5259-496f-91c1-b560bdb757d6"), new DateTime(today.Year, today.Month, today.Day+1, 20, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));

            Screenings.Add(new Screening (new Guid("b19a13b4-192e-4237-8dc9-f82b8002be81"), new DateTime(today.Year, today.Month, today.Day+2, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("a6ed14d4-ddd8-4a4b-a73c-547470ef134d"), new DateTime(today.Year, today.Month, today.Day+3, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            #endregion

            #region "Diuna"
            Screenings.Add(new Screening(new Guid("4fbab7c7-eb59-4731-bb40-b32860530d39"), new DateTime(today.Year, today.Month, today.Day, 15, 45, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("aafd560f-d000-4445-8103-4e13e249f083"), new DateTime(today.Year, today.Month, today.Day, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("5bef6600-8104-4074-a0ee-6400f5da6ed2"), new DateTime(today.Year, today.Month, today.Day, 20, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("fb5cff0c-eddb-41a9-85f2-2d9f90b5e5e6"), new DateTime(today.Year, today.Month, today.Day+4, 21, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("24ebed85-906c-422d-b20a-657153d6050c"), new DateTime(today.Year, today.Month, today.Day+1, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("fb5cff0c-eddb-41a9-85f2-2d9f90b5e5e6"), new DateTime(today.Year, today.Month, today.Day+1, 21, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("165fa459-6cda-4034-a043-0d57f4af281b"), new DateTime(today.Year, today.Month, today.Day+1, 14, 40, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("2b40fdf7-e4dc-431b-b4ad-aeb5159a2d81"), new DateTime(today.Year, today.Month, today.Day+1, 20, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("a26e331a-b1b6-4deb-a258-0334c07f1e8f"), new DateTime(today.Year, today.Month, today.Day+2, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("dd60576e-bf60-46f5-b268-fcb8c0e4660d"), new DateTime(today.Year, today.Month, today.Day+3, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("097bba1b-aabc-49dc-a156-bbe8db8f5a6a")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            #endregion

            #region "Nie czas umierać"
            Screenings.Add(new Screening(new Guid("a54b2b6d-ba61-4c32-a3bb-f2d206cac6a7"), new DateTime(today.Year, today.Month, today.Day, 08, 00, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("6bb909d4-57a4-48a3-b067-65edbe64ad3d")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("6296b64d-889d-4e90-bdce-dde0dc82c298"), new DateTime(today.Year, today.Month, today.Day, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("d64b9278-b33f-4a01-813a-cfba376c7085"), new DateTime(today.Year, today.Month, today.Day+1, 11, 30, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("25259578-b4a5-47b2-b5cc-d8efc4fb09ad"), new DateTime(today.Year, today.Month, today.Day+1, 16, 15, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("92d84288-12ef-41d3-a9c6-e5744a991952"), new DateTime(today.Year, today.Month, today.Day+1, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("96bf3e4e-40ed-41a0-8d43-06403bce1245"), new DateTime(today.Year, today.Month, today.Day+2, 17, 00, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("05c7b8a9-7f38-4de1-9a53-0f923e5a34a4"), new DateTime(today.Year, today.Month, today.Day+2, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("1654edd2-8443-4fa3-9bfb-8686d5d27710")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            #endregion

            #region "Cruella"
            Screenings.Add(new Screening(new Guid("55d73371-2071-4613-9169-d0cde3fa8b8b"), new DateTime(today.Year, today.Month, today.Day, 08, 00, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("6bb909d4-57a4-48a3-b067-65edbe64ad3d")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("7a597459-4c1a-4460-afe9-1b7d7b80e9f8"), new DateTime(today.Year, today.Month, today.Day, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("1c7711f1-d474-4cf9-857e-c49414f7f7fe"), new DateTime(today.Year, today.Month, today.Day+1, 11, 30, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("34c1cd8f-84dd-4f36-98b4-d0b202bdae31"), new DateTime(today.Year, today.Month, today.Day+1, 16, 15, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("acc36232-0549-4d7e-9746-33d3869813e9"), new DateTime(today.Year, today.Month, today.Day+1, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("7d8bf93d-76f4-4974-932a-ac0c7883c7db"), new DateTime(today.Year, today.Month, today.Day+2, 17, 00, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("0cb76a43-d44c-4689-8dcf-cbbdf50c8d2c"), new DateTime(today.Year, today.Month, today.Day+2, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("f80a02d4-f806-4723-90a1-4b25c633a818")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            #endregion

            #region "Czarna Wdowa"
            Screenings.Add(new Screening(new Guid("2ff2e221-69be-4628-9b28-144d965ef147"), new DateTime(today.Year, today.Month, today.Day, 08, 00, 00), Movies.Where(item => item.movieID == new Guid("f66f43cb-d5bf-4aa9-9c31-9544320070c8")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("6bb909d4-57a4-48a3-b067-65edbe64ad3d")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("703b458f-afd1-46bf-bd49-004c4429314b"), new DateTime(today.Year, today.Month, today.Day, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("f66f43cb-d5bf-4aa9-9c31-9544320070c8")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));

            Screenings.Add(new Screening(new Guid("27666fd8-93fd-4465-aab0-456476b657e5"), new DateTime(today.Year, today.Month, today.Day+1, 11, 30, 00), Movies.Where(item => item.movieID == new Guid("f66f43cb-d5bf-4aa9-9c31-9544320070c8")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("b3162fb0-1d43-4381-87dd-55e6ad9d02e4"), new DateTime(today.Year, today.Month, today.Day+1, 16, 15, 00), Movies.Where(item => item.movieID == new Guid("f66f43cb-d5bf-4aa9-9c31-9544320070c8")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("694025a3-c7a5-4464-a78a-ce666f19da37")).FirstOrDefault()));
            Screenings.Add(new Screening(new Guid("2465cf5f-6d9f-4469-be8f-033369ca6fc6"), new DateTime(today.Year, today.Month, today.Day+1, 19, 30, 00), Movies.Where(item => item.movieID == new Guid("f66f43cb-d5bf-4aa9-9c31-9544320070c8")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            #endregion
