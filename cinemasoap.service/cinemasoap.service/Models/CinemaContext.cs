...
namespace cinemasoap.service.Models
{
    public class CinemaContext 
    {
        ...
        private void InitScreenings()
        {
            ...
            Screenings.Add(new Screening (new Guid("8a4b86e4-acc9-476f-bae4-a58038791ed6"), new DateTime(2021, 5, 14, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("aca6edd2-85d3-4673-af10-4007fb749e9f"), new DateTime(2021, 5, 15, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("0cc4d40c-71d9-4f5a-a75a-b8230735689f"), new DateTime(2021, 5, 15, 14, 40, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("b19a13b4-192e-4237-8dc9-f82b8002be81"), new DateTime(2021, 5, 16, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("bd54a687-65b7-460a-acef-1431960f1e78"), new DateTime(2021, 5, 14, 20, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
            Screenings.Add(new Screening (new Guid("a6ed14d4-ddd8-4a4b-a73c-547470ef134d"), new DateTime(2021, 5, 16, 12, 00, 00), Movies.Where(item => item.movieID == new Guid("c2b5f1fa-976b-4836-b0d6-0ee2d8e4efe0")).FirstOrDefault(), Screens.Where(item => item.screenID == new Guid("40bf5176-ebac-4b14-aaf8-da474480e432")).FirstOrDefault()));
